        ...
        <>
            <div className='sidebar'>
                ...
                <nav className="sidebar__list">
                    ...
                    <NavLink to={'/pages/home'} className={(active) => active.isActive ? "sidebar__list-item active" : "sidebar__list-item"}>
                    ...
                    <NavLink to={'/pages/search'} className={(active) => active.isActive ? "sidebar__list-item active" : "sidebar__list-item"}><div className="sidebar__list-item-image"><svg width="30px" height="30px" viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <NavLink to={'/pages/notifications'} className={(active) => active.isActive ? "sidebar__list-item active" : "sidebar__list-item"}><div className="sidebar__list-item-image"><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <NavLink to={'/pages/messages'} className="sidebar__list-item"><div className="sidebar__list-item-image"><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <NavLink to={'/pages/bookmarks'} className={(active) => active.isActive ? "sidebar__list-item active" : "sidebar__list-item"}><div className="sidebar__list-item-image"><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <NavLink to={'/pages/lists'} className={(active) => active.isActive ? "sidebar__list-item active" : "sidebar__list-item"}><div className="sidebar__list-item-image"><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <NavLink to={'/pages/profile'} className={(active) => active.isActive ? "sidebar__list-item active" : "sidebar__list-item"}><div className="sidebar__list-item-image"><svg width="30px" height="30px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
